                    ...
                    <div class="card-body">
                        <ul class="list-unstyled list-unstyled-border">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <div class="float-right text-primary">10m</div>
                                    <div class="media-title">Farhan B Mujib</div>
                                    <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin.</span>
                                </div>
                            </li>
                            <li class="media">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td> 
                                            Introduction Laravel 5 <div class="table-links"> in <a href="#">Web Development</a> <div class="bullet"></div> <a href="#">View</a> </div>
                                        </td>
                                        <td>
